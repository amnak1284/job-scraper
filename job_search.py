...
skills = get_program_arguments()
print(skills)
url = 'https://www.indeed.com/jobs?q='+ skills +'&l=San%20Francisco%2C%20CA'
print(url)

jobs_array = job_scraper(url)
create_csv(jobs_array)
